1. Project presentation
    ...
    Evently is a sleek, glassmorphism-inspired event management platform designed for educational campus environments. It serves as a centralized hub where students can discover upcoming school activities and admins can manage event logistics in real-time.
    ...
    c. Tech Stack: Why TypeScript + HTML/CSS?
    ...
    A standout feature of the code is the Atomic Update logic. When a user clicks "Book," the TypeScript engine:
        ...
        Checks if currentBookings < capacity.

        If true, it updates the User object (adding the ID).

        Simultaneously updates the Event object (incrementing the count).
